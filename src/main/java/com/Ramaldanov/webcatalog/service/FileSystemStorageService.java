...
import com.Ramaldanov.webcatalog.exceptions.StorageException;
...
public class FileSystemStorageService implements StorageService {
    ...
    @Override
    public boolean deleteByPath(String pathToDelete) {
        Path path = rootLocation.resolve(pathToDelete);
        try {
